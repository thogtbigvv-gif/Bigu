...
const { settings, progress, journal, practice, favorites, sentences, STORES, isStoreShaped, isAvailable, clearAll } = storage;
...
describe('corrupted keys', () => {
  ...
  test('a map store reading null, a number or an array falls back to {}', () => {
    for (const junk of ['null', '5', '[]', '"a string"']) {
      installMemoryStorage();
      localStorage.setItem('nagi:progress', junk);
